> 目录已整理：返回[仓库首页](../../README.md)，查看 [Windows](../../win/README.md) 或 [macOS](../../mac/README.md)。本文保留完整功能说明；源码构建请从各平台的“源码”目录进入。
...
<p>
  <img src="../../mac/源码/assets/CodexMeter-icon.png" alt="CodexMeter 应用图标" width="128">
</p>
...
| 深色界面 | 浅色界面 |
|:---:|:---:|
| <img src="../../mac/源码/assets/codexmeter-dark.png" alt="CodexMeter 深色界面" width="344"> | <img src="../../mac/源码/assets/codexmeter-light.png" alt="CodexMeter 浅色界面" width="344"> |
...
Windows 的构建、安装和故障排查请看 [Windows 详细说明](../../win/源码/README.zh-CN.md)。不同平台的版本差异请看 [`VERSION-GUIDE.md`](VERSION-GUIDE.md)。
...
CodexMeter 是基于 [steipete/CodexBar](https://github.com/steipete/CodexBar) 的独立、非官方应用。Windows v0.1.4 内置 [Win-CodexBar](https://github.com/nesszer/Win-CodexBar) CLI 0.45.2，macOS v0.2.0 内置上游 CodexBar CLI；对应完整 MIT 许可证位于各平台源码目录的 `ThirdPartyLicenses/` 和各安装包内。
